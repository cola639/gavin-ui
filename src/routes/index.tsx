...
// ---- fetched router data with user token, if not redirect to user login----
const fetchJson = await fetchRoutes();
...
// api/routes.ts
import type { BackendRoute } from './RouteFactory';

// Mock: pretend to call your backend API
export async function fetchRoutes(): Promise<BackendRoute[]> {
  // simulate network latency
  await new Promise((res) => setTimeout(res, 2000));

  // return the JSON you showed (can be dynamic)
  return [
    {
      name: 'view',
      path: '/view',
